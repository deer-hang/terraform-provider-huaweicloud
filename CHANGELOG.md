...
* **New Resource Source:**
  ...
  + `huaweicloud_drs_backup_migration` [GH-9826]
  + `huaweicloud_drs_batch_set_definer` [GH-9811]
  + `huaweicloud_drs_connection` [GH-9759]
  + `huaweicloud_drs_update_data_progress_rules` [GH-9782]
  + `huaweicloud_elb_listener_copy` [GH-9822]
  + `huaweicloud_gaussdb_dr_configuration_reset` [GH-9794]
  + `huaweicloud_gaussdb_dr_relationship` [GH-9808]
  + `huaweicloud_gaussdb_instance_password_reset` [GH-9793]
  + `huaweicloud_geminidb_database_upgrade` [GH-9755]
  + `huaweicloud_geminidb_eip_bind` [GH-9818]
  + `huaweicloud_geminidb_enlarge_fail_node_delete` [GH-9827]
  + `huaweicloud_geminidb_parameter_template_copy` [GH-9758]
  + `huaweicloud_hss_host_batch_config` [GH-9804]
  + `huaweicloud_modelarts_training_job` [GH-9800]
  + `huaweicloud_modelartsv2_workflow_execution_action` [GH-9760]
  + `huaweicloud_obs_bucket_object_restore` [GH-9842]
  + `huaweicloud_taurusdb_htap_sessions_kill` [GH-9812]
  + `huaweicloud_taurusdb_htap_starrocks_instance_upgrade` [GH-9835]
  + `huaweicloud_taurusdb_primary_standby_switch` [GH-9844]

* **New Data Source:**
  + `huaweicloud_css_cluster_volume_usage` [GH-9792]
  + `huaweicloud_css_disk_types` [GH-9797]
  + `huaweicloud_das_connection_instance_snapshots` [GH-9791]
  + `huaweicloud_das_history_transaction_exported_tasks` [GH-9772]
  + `huaweicloud_das_instance_metadata_locks` [GH-9787]
  + `huaweicloud_das_instance_processes` [GH-9805]
  + `huaweicloud_das_instances` [GH-9824]
  + `huaweicloud_das_shared_connections` [GH-9795]
  + `huaweicloud_das_sql_execution_plans` [GH-9802]
  + `huaweicloud_dcs_background_task_detail` [GH-9784]
  + `huaweicloud_drs_backup_migration_jobs` [GH-9826]
  + `huaweicloud_drs_batch_rpos_and_rtos` [GH-9774]
  + `huaweicloud_drs_batch_struct_detail` [GH-9796]
  + `huaweicloud_drs_connections` [GH-9759]
  + `huaweicloud_drs_support_links` [GH-9816]
  + `huaweicloud_eg_eventrouter_clusters` [GH-9739]
  + `huaweicloud_gaussdb_alarms` [GH-9783]
  + `huaweicloud_gaussdb_all_instances_metrics` [GH-9814]
  + `huaweicloud_gaussdb_global_slow_sql_detail` [GH-9831]
  + `huaweicloud_gaussdb_instance_alarm_statistics` [GH-9817]
  + `huaweicloud_gaussdb_instance_installed_plugins` [GH-9846]
  + `huaweicloud_gaussdb_instance_status_statistics` [GH-9820]
  + `huaweicloud_gaussdb_instance_supported_plugins` [GH-9854]
  + `huaweicloud_gaussdb_slow_sql_detail` [GH-9832]
  + `huaweicloud_gaussdb_slow_sql_list` [GH-9781]
  + `huaweicloud_gaussdb_slow_sql_nodes` [GH-9775]
  + `huaweicloud_modelarts_algorithms` [GH-9769]
  + `huaweicloud_modelarts_training_experiments` [GH-9773]
  + `huaweicloud_modelarts_training_job_engines` [GH-9800]
  + `huaweicloud_modelarts_training_job_flavors` [GH-9803]
  + `huaweicloud_modelartsv2_workflow_executions` [GH-9757]
  + `huaweicloud_obs_bucket_mirror_back_to_source_rules` [GH-9848]
  + `huaweicloud_secmaster_cloud_log_platforms` [GH-9841]
  + `huaweicloud_secmaster_moniter_metric_stats` [GH-9851]
  + `huaweicloud_secmaster_platform_managed` [GH-9847]
  + `huaweicloud_secmaster_siem_shippers` [GH-9821]
  + `huaweicloud_swr_enterprise_all_repositories` [GH-9788]
  + `huaweicloud_swr_enterprise_instance_repositories` [GH-9788]
  + `huaweicloud_swr_enterprise_instance_repository_tags` [GH-9788]
  + `huaweicloud_taurusdb_htap_sessions` [GH-9810]
  + `huaweicloud_taurusdb_instance_backups` [GH-9850]
  + `huaweicloud_vpn_connection_ipsec_sa` [GH-9838]
  + `huaweicloud_vpn_connection_peer_configuration_export` [GH-9840]
  + `huaweicloud_vpn_gateway_certificates` [GH-9839]
  + `huaweicloud_vpn_metrics` [GH-9838]
  + `huaweicloud_vpn_peer_configuration_supported_devices` [GH-9838]

## 1.92.0 (May 31, 2026)

* **New Resource Source:**
  + `huaweicloud_cce_cluster_pod_identity_association` [GH-9570]
  + `huaweicloud_cce_nodes_certificate_rotatecredentials` [GH-9582]
  + `huaweicloud_css_snapshot_setting` [GH-9425]
  + `huaweicloud_css_vpcep_connections_update` [GH-9398]
  + `huaweicloud_das_binlog_parse_task_export` [GH-9712]
  + `huaweicloud_das_binlog_parse_task` [GH-9692]
  + `huaweicloud_das_database_instance_connection` [GH-9725]
  + `huaweicloud_das_database_user` [GH-9725]
  + `huaweicloud_das_email_template` [GH-9653]
  + `huaweicloud_das_email_templates_batch_action` [GH-9653]
  + `huaweicloud_das_emails_batch_send` [GH-9681]
  + `huaweicloud_das_history_transaction_switch` [GH-9753]
  + `huaweicloud_das_instance_group_assign` [GH-9653]
  + `huaweicloud_das_instance_group` [GH-9725]
  + `huaweicloud_das_sql_limiting_switch` [GH-9764]
  + `huaweicloud_dataarts_architecture_aggregation_logic_table` [GH-9562]
  + `huaweicloud_dataarts_architecture_approvals_batch_action` [GH-9504]
  + `huaweicloud_dataarts_dataservice_instance_log_dump` [GH-9523]
  + `huaweicloud_dcs_all_sessions_kill` [GH-9540]
  + `huaweicloud_dcs_center_task_delete` [GH-9638]
  + `huaweicloud_dcs_instance_minor_version_upgrade` [GH-9698]
  + `huaweicloud_dcs_logout_web_cli` [GH-9478]
  + `huaweicloud_dcs_node_priority_config` [GH-9718]
  + `huaweicloud_dcs_node_status_change` [GH-9729]
  + `huaweicloud_dcs_sessions_kill` [GH-9553]
  + `huaweicloud_dcs_sessions_query` [GH-9501]
  + `huaweicloud_dcs_web_cli_command_execute` [GH-9488]
  + `huaweicloud_dds_backup_download_policy` [GH-9467]
  + `huaweicloud_dds_ip_address` [GH-9484]
  + `huaweicloud_dds_readonly_node` [GH-9454]
  + `huaweicloud_dms_kafka_instance_log` [GH-9714]
  + `huaweicloud_drs_batch_delete_jobs` [GH-9623]
  + `huaweicloud_drs_batch_pause_task` [GH-9595]
  + `huaweicloud_drs_batch_retry_task` [GH-9652]
  + `huaweicloud_drs_check_data_filter` [GH-9711]
  + `huaweicloud_drs_compare_job_cancel` [GH-9749]
  + `huaweicloud_drs_compare_policy` [GH-9683]
  + `huaweicloud_drs_driver_delete` [GH-9687]
  + `huaweicloud_drs_job_clone` [GH-9557]
  + `huaweicloud_drs_job_configuration_update` [GH-9623]
  + `huaweicloud_drs_jobs_batch_stop` [GH-9664]
  + `huaweicloud_drs_lts_config` [GH-9623]
  + `huaweicloud_drs_name_validation` [GH-9576]
  + `huaweicloud_drs_object_compare` [GH-9723]
  + `huaweicloud_drs_pwd_batch_modify` [GH-9643]
  + `huaweicloud_drs_smn_batch_set` [GH-9693]
  + `huaweicloud_eg_eventrouter_cluster` [GH-9724]
  + `huaweicloud_eip_bandwidth_associate` [GH-9527]
  + `huaweicloud_gaussdb_asp_collect` [GH-9696]
  + `huaweicloud_gaussdb_read_replica` [GH-9740]
  + `huaweicloud_gaussdb_wdr_snapshot_collect` [GH-9696]
  + `huaweicloud_gaussdb_wdr_snapshot` [GH-9696]
  + `huaweicloud_geminidb_backup_stop` [GH-9689]
  + `huaweicloud_geminidb_backup` [GH-9733]
  + `huaweicloud_geminidb_instance_restart` [GH-9690]
  + `huaweicloud_geminidb_memory_mapping` [GH-9733]
  + `huaweicloud_geminidb_memory_rule` [GH-9733]
  + `huaweicloud_geminidb_node_session_kill` [GH-9689]
  + `huaweicloud_geminidb_parameter_template_compare` [GH-9689]
  + `huaweicloud_geminidb_parameter_template_reset` [GH-9726]
  + `huaweicloud_geminidb_parameter_template` [GH-9689]
  + `huaweicloud_geminidb_primary_standby_switch` [GH-9726]
  + `huaweicloud_geminidb_recycling_policy` [GH-9689]
  + `huaweicloud_global_eip_internet_bandwidth_associate` [GH-9535]
  + `huaweicloud_global_eip_segment_bandwidth_associate` [GH-9561]
  + `huaweicloud_global_eip_segment_instance_associate` [GH-9666]
  + `huaweicloud_global_eip_segment` [GH-9589]
  + `huaweicloud_hss_custom_rule` [GH-9765]
  + `huaweicloud_modelarts_algorithm` [GH-9631]
  + `huaweicloud_modelarts_notebook_image_store` [GH-9651]
  + `huaweicloud_modelarts_training_experiment` [GH-9534]
  + `huaweicloud_modelartsv2_node_batch_lock` [GH-9513]
  + `huaweicloud_modelartsv2_node_batch_migrate` [GH-9560]
  + `huaweicloud_modelartsv2_node_batch_reset` [GH-9544]
  + `huaweicloud_modelartsv2_node_batch_unlock` [GH-9513]
  + `huaweicloud_modelartsv2_workflow_execution` [GH-9731]
  + `huaweicloud_modelartsv2_workflow_schedule` [GH-9500]
  + `huaweicloud_modelartsv2_workflow_subscription` [GH-9668]
  + `huaweicloud_modelartsv2_workflow` [GH-9716]
  + `huaweicloud_rds_agent_job_modify` [GH-9507]
  + `huaweicloud_rds_agent_job_restart` [GH-9505]
  + `huaweicloud_rds_agent_job_switch` [GH-9503]
  + `huaweicloud_rds_database_statistics_update` [GH-9532]
  + `huaweicloud_rds_event_operate` [GH-9556]
  + `huaweicloud_rds_standby_instance_rebuild` [GH-9541]
  + `huaweicloud_taurusdb_htap_starrocks_instance_restart` [GH-9675]
  + `huaweicloud_taurusdb_htap_starrocks_node_restart` [GH-9685]
  + `huaweicloud_taurusdb_node_sessions_kill` [GH-9675]
  + `huaweicloud_taurusdb_sql_auto_throttling` [GH-9654]
  + `huaweicloud_vpc_eip_update_publicip_pool` [GH-9474]

* **New Data Source:**
  + `huaweicloud_cce_cluster_pod_identity_associations` [GH-9570]
  + `huaweicloud_cce_cluster_pod_identity_assume_agency` [GH-9564]
  + `huaweicloud_css_cluster_logs` [GH-9373]
  + `huaweicloud_das_binlog_exported_parse_tasks` [GH-9737]
  + `huaweicloud_das_binlogs` [GH-9725]
  + `huaweicloud_das_database_instance_connections` [GH-9725]
  + `huaweicloud_das_database_users` [GH-9725]
  + `huaweicloud_das_email_send_records` [GH-9743]
  + `huaweicloud_das_history_transactions` [GH-9751]
  + `huaweicloud_das_inspection_reports` [GH-9725]
  + `huaweicloud_das_instance_groups` [GH-9725]
  + `huaweicloud_dataarts_architecture_aggregation_logic_tables` [GH-9562]
  + `huaweicloud_dataarts_architecture_business_metrics` [GH-9694]
  + `huaweicloud_dataarts_architecture_code_tables` [GH-9719]
  + `huaweicloud_dataarts_architecture_data_standards` [GH-9732]
  + `huaweicloud_dataarts_architecture_directories` [GH-9713]
  + `huaweicloud_dataarts_architecture_models` [GH-9499]
  + `huaweicloud_dataarts_architecture_subjects` [GH-9572]
  + `huaweicloud_dataarts_architecture_table_model_relations` [GH-9548]
  + `huaweicloud_dataarts_dataservice_catalogs` [GH-9542]
  + `huaweicloud_dataarts_security_data_categories` [GH-9571]
  + `huaweicloud_dataarts_security_data_recognition_rule_groups` [GH-9423]
  + `huaweicloud_dataarts_security_data_secrecy_levels` [GH-9702]
  + `huaweicloud_dataarts_studio_instances` [GH-9707]
  + `huaweicloud_dcs_clients` [GH-9515]
  + `huaweicloud_dcs_instance_engine_version` [GH-9632]
  + `huaweicloud_dcs_instance_rename_commands` [GH-9665]
  + `huaweicloud_dcs_instance_status` [GH-9658]
  + `huaweicloud_dcs_instance_topology` [GH-9680]
  + `huaweicloud_dcs_primary_dim_monitored_objects` [GH-9566]
  + `huaweicloud_dcs_redis_log_download_link` [GH-9584]
  + `huaweicloud_dcs_secondary_dim_monitored_objects` [GH-9567]
  + `huaweicloud_dcs_slow_logs` [GH-9600]
  + `huaweicloud_dcs_ssl_cert_download` [GH-9614]
  + `huaweicloud_dcs_tags` [GH-9585]
  + `huaweicloud_drs_actions` [GH-9683]
  + `huaweicloud_drs_agency_permissions` [GH-9700]
  + `huaweicloud_drs_batch_async_jobs` [GH-9683]
  + `huaweicloud_drs_batch_get_params` [GH-9683]
  + `huaweicloud_drs_batch_progresses` [GH-9683]
  + `huaweicloud_drs_batch_struct_process` [GH-9708]
  + `huaweicloud_drs_compare_content_detail` [GH-9683]
  + `huaweicloud_drs_compare_content_overview` [GH-9683]
  + `huaweicloud_drs_compare_line_detail` [GH-9715]
  + `huaweicloud_drs_compare_line_overview` [GH-9683]
  + `huaweicloud_drs_compare_policy` [GH-9683]
  + `huaweicloud_drs_compare_progress` [GH-9683]
  + `huaweicloud_drs_compare_result` [GH-9683]
  + `huaweicloud_drs_configuration_histories` [GH-9704]
  + `huaweicloud_drs_data_processing_rules` [GH-9697]
  + `huaweicloud_drs_db_object` [GH-9695]
  + `huaweicloud_drs_ddls` [GH-9727]
  + `huaweicloud_drs_dirty_data` [GH-9709]
  + `huaweicloud_drs_disaster_monitoring_data` [GH-9722]
  + `huaweicloud_drs_drivers` [GH-9683]
  + `huaweicloud_drs_health_compare_jobs` [GH-9750]
  + `huaweicloud_drs_health_compare_overview` [GH-9720]
  + `huaweicloud_drs_instances_by_tags` [GH-9734]
  + `huaweicloud_drs_job_configurations` [GH-9683]
  + `huaweicloud_drs_job_links` [GH-9683]
  + `huaweicloud_drs_job_metering` [GH-9683]
  + `huaweicloud_drs_job_monitor_data` [GH-9683]
  + `huaweicloud_drs_job_object_support` [GH-9683]
  + `huaweicloud_drs_object_compare_detail` [GH-9723]
  + `huaweicloud_drs_object_compare` [GH-9723]
  + `huaweicloud_drs_object_mappings` [GH-9683]
  + `huaweicloud_drs_progress_data` [GH-9683]
  + `huaweicloud_drs_quotas` [GH-9683]
  + `huaweicloud_drs_replay_progress` [GH-9683]
  + `huaweicloud_drs_subscriptions` [GH-9683]
  + `huaweicloud_drs_table_compare` [GH-9683]
  + `huaweicloud_drs_tags` [GH-9683]
  + `huaweicloud_drs_timelines` [GH-9683]
  + `huaweicloud_eip_publicip_count` [GH-9589]
  + `huaweicloud_eip_publicip_instances_count` [GH-9589]
  + `huaweicloud_eip_publicip_types` [GH-9589]
  + `huaweicloud_eip_publicips_by_tags` [GH-9589]
  + `huaweicloud_eip_quotas` [GH-9589]
  + `huaweicloud_gaussdb_asp_collection_results` [GH-9696]
  + `huaweicloud_gaussdb_wdr_snapshot_collection_results` [GH-9696]
  + `huaweicloud_geminidb_available_flavors` [GH-9741]
  + `huaweicloud_geminidb_backups` [GH-9733]
  + `huaweicloud_geminidb_database_versions` [GH-9733]
  + `huaweicloud_geminidb_dedicated_resources` [GH-9733]
  + `huaweicloud_geminidb_instance_parameters_histories` [GH-9733]
  + `huaweicloud_geminidb_instance_sessions` [GH-9733]
  + `huaweicloud_geminidb_memory_mappings` [GH-9733]
  + `huaweicloud_geminidb_memory_rules` [GH-9733]
  + `huaweicloud_geminidb_node_session_statistics` [GH-9733]
  + `huaweicloud_geminidb_node_sessions` [GH-9733]
  + `huaweicloud_geminidb_pt_applicable_instances` [GH-9733]
  + `huaweicloud_geminidb_pt_appliction_records` [GH-9742]
  + `huaweicloud_geminidb_quotas` [GH-9733]
  + `huaweicloud_geminidb_recycling_instances` [GH-9733]
  + `huaweicloud_geminidb_restorable_time_window` [GH-9733]
  + `huaweicloud_geminidb_ssl_cert_download_links` [GH-9733]
  + `huaweicloud_geminidb_table_restored_databases` [GH-9733]
  + `huaweicloud_geminidb_table_restored_tables` [GH-9733]
  + `huaweicloud_global_eip_bindings` [GH-9589]
  + `huaweicloud_global_eip_internet_bandwidth_limits` [GH-9589]
  + `huaweicloud_global_eip_segment_support_masks` [GH-9589]
  + `huaweicloud_global_eip_segment_tags` [GH-9636]
  + `huaweicloud_global_eip_segments_by_tags` [GH-9634]
  + `huaweicloud_global_eip_segments` [GH-9589]
  + `huaweicloud_global_eip_support_regions` [GH-9589]
  + `huaweicloud_global_eip_tenant_support_regions` [GH-9608]
  + `huaweicloud_global_eips_by_tags` [GH-9624]
  + `huaweicloud_hss_ai_component_detail` [GH-9754]
  + `huaweicloud_hss_ai_component_statistics` [GH-9744]
  + `huaweicloud_hss_common_hosts` [GH-9767]
  + `huaweicloud_hss_custom_rules` [GH-9765]
  + `huaweicloud_hss_overview_risk_score` [GH-9728]
  + `huaweicloud_hss_security_reports` [GH-9735]
  + `huaweicloud_modelarts_devserver_flavors` [GH-9477]
  + `huaweicloud_modelarts_devserver_plugins` [GH-9661]
  + `huaweicloud_modelarts_networks` [GH-9497]
  + `huaweicloud_modelarts_notebooks` [GH-9511]
  + `huaweicloud_modelarts_workspace_quotas` [GH-9492]
  + `huaweicloud_modelartsv2_plugin_templates` [GH-9518]
  + `huaweicloud_modelartsv2_plugins` [GH-9500]
  + `huaweicloud_modelartsv2_resource_pool_workloads` [GH-9500]
  + `huaweicloud_modelartsv2_workflow_schedules` [GH-9500]
  + `huaweicloud_modelartsv2_workflows` [GH-9716]
  + `huaweicloud_rds_agent_job_histories` [GH-9489]
  + `huaweicloud_rds_agent_job_history_steps` [GH-9491]
  + `huaweicloud_rds_agent_jobs` [GH-9487]
  + `huaweicloud_rds_available_upgrade_small_versions` [GH-9522]
  + `huaweicloud_rds_events` [GH-9526]
  + `huaweicloud_rds_merged_binlog_files` [GH-9524]
  + `huaweicloud_rfs_stack_sets` [GH-9546]
  + `huaweicloud_taurusdb_htap_datastores` [GH-9654]
  + `huaweicloud_taurusdb_htap_flavors` [GH-9654]
  + `huaweicloud_taurusdb_htap_instances` [GH-9654]
  + `huaweicloud_taurusdb_htap_primary_instance_databases` [GH-9654]
  + `huaweicloud_taurusdb_htap_primary_instance_tables` [GH-9667]
  + `huaweicloud_taurusdb_htap_starrocks_databases` [GH-9654]
  + `huaweicloud_taurusdb_htap_starrocks_nodes` [GH-9654]
  + `huaweicloud_taurusdb_htap_storage_types` [GH-9654]
  + `huaweicloud_taurusdb_node_sessions` [GH-9654]
  + `huaweicloud_taurusdb_sql_auto_throttling_records` [GH-9654]
  + `huaweicloud_taurusdb_sql_control_history_rules` [GH-9654]
  + `huaweicloud_vpc_peering_connections` [GH-9538]

## 1.91.0 (April 30, 2026)

* **New Resource Source:**
  + `huaweicloud_as_warm_pool` [GH-9345]
  + `huaweicloud_cfw_add_dns_server` [GH-9295]
  + `huaweicloud_cfw_advanced_ips_rule` [GH-9163]
  + `huaweicloud_cfw_batch_delete_address_group_members` [GH-9295]
  + `huaweicloud_cfw_batch_delete_address_groups` [GH-9376]
  + `huaweicloud_cfw_batch_delete_domain_sets` [GH-9295]
  + `huaweicloud_cfw_batch_delete_service_group_members` [GH-9300]
  + `huaweicloud_cfw_batch_update_ips_custom_rules` [GH-9305]
  + `huaweicloud_cfw_export_acl_rule` [GH-9319]
  + `huaweicloud_cfw_ip_blacklist_switch` [GH-9152]
  + `huaweicloud_dataarts_catalog_metadata_task_action` [GH-9370]
  + `huaweicloud_dataarts_catalog_metadata_task` [GH-9401]
  + `huaweicloud_dataarts_factory_script_execute` [GH-9292]
  + `huaweicloud_dataarts_security_data_recognition_rule_group` [GH-9389]
  + `huaweicloud_dataarts_security_dynamic_masking_policy` [GH-9391]
  + `huaweicloud_dataarts_security_resource_permission_policy` [GH-9407]
  + `huaweicloud_dataarts_security_workspace_queue_associate` [GH-9365]
  + `huaweicloud_dataarts_studio_workspace_user` [GH-9380]
  + `huaweicloud_dcs_background_task_delete` [GH-9434]
  + `huaweicloud_dcs_instance_expired_key_scan` [GH-7410]
  + `huaweicloud_dcs_offline_key_analysis` [GH-9266]
  + `huaweicloud_dcs_redis_run_log_collect` [GH-9337]
  + `huaweicloud_dds_backup_stop` [GH-9410]
  + `huaweicloud_dli_flink_job_export` [GH-9299]
  + `huaweicloud_dli_flink_job_import` [GH-9299]
  + `huaweicloud_dms_rabbitmq_recycle_instance_restore` [GH-9341]
  + `huaweicloud_dms_rabbitmq_volume_auto_expand_configuration` [GH-9335]
  + `huaweicloud_dms_rocketmq_volume_auto_expand_configuration` [GH-9352]
  + `huaweicloud_drs_download_batch_create_template` [GH-9447]
  + `huaweicloud_drs_stop_job` [GH-9460]
  + `huaweicloud_dws_cluster_action` [GH-9280]
  + `huaweicloud_dws_logical_cluster_plan` [GH-9278]
  + `huaweicloud_dws_workload_queue_update_action` [GH-9214]
  + `huaweicloud_elb_domain_address` [GH-9357]
  + `huaweicloud_elb_domain_resolution` [GH-9327]
  + `huaweicloud_gaussdb_client_auth_config` [GH-9362]
  + `huaweicloud_gaussdb_opengauss_client_auth_config` [GH-9362]
  + `huaweicloud_geminidb_account` [GH-9456]
  + `huaweicloud_obs_bucket_bpa` [GH-9461]
  + `huaweicloud_organizations_dry_run_policy_entity_attach` [GH-9268]
  + `huaweicloud_organizations_policy_dry_run_configuration` [GH-9265]
  + `huaweicloud_rds_publication_snapshot_regenerate` [GH-9445]
  + `huaweicloud_rds_subscription_regenerate` [GH-9451]
  + `huaweicloud_rds_subscription` [GH-9441]
  + `huaweicloud_rfs_apply_execution_plan` [GH-9411]
  + `huaweicloud_rfs_continue_deploy_stack` [GH-9414]
  + `huaweicloud_rfs_execution_plan_v2` [GH-9408]
  + `huaweicloud_rfs_private_module_version` [GH-9356]
  + `huaweicloud_rfs_private_module` [GH-9356]
  + `huaweicloud_rfs_private_provider_version` [GH-9381]
  + `huaweicloud_rfs_private_provider` [GH-9356]
  + `huaweicloud_rfs_stack_rollback` [GH-9361]
  + `huaweicloud_rfs_stack_set_deployment` [GH-9372]
  + `huaweicloud_rfs_stack_set` [GH-9356]
  + `huaweicloud_rfs_template_analysis_variables` [GH-9361]
  + `huaweicloud_rfs_template_version` [GH-9385]
  + `huaweicloud_rfs_template` [GH-9356]
  + `huaweicloud_smn_topic_subscription` [GH-9284]
  + `huaweicloud_smn_topic_unsubscription` [GH-9384]
  + `huaweicloud_vpc_eip_bandwidth_rule` [GH-9450]
  + `huaweicloud_vpcep_endpoint_upgrade` [GH-9311]
  + `huaweicloud_vpcep_service_add_servers` [GH-9316]

* **New Data Source:**
  + `huaweicloud_as_warm_pool_instances` [GH-9345]
  + `huaweicloud_cfw_acl_rule_hit_info` [GH-9294]
  + `huaweicloud_cfw_acl_rule_import_status` [GH-9336]
  + `huaweicloud_cfw_attack_log_total` [GH-9263]
  + `huaweicloud_cfw_firewall_router` [GH-9287]
  + `huaweicloud_cfw_flow_log_trend` [GH-9291]
  + `huaweicloud_cfw_logs` [GH-9289]
  + `huaweicloud_cfw_organization_tree` [GH-9276]
  + `huaweicloud_cfw_report_history` [GH-9304]
  + `huaweicloud_dataarts_architecture_approvals` [GH-9465]
  + `huaweicloud_dataarts_architecture_data_standard_template_customs` [GH-9433]
  + `huaweicloud_dataarts_architecture_data_standard_template_optionals` [GH-9415]
  + `huaweicloud_dataarts_architecture_processes` [GH-9415]
  + `huaweicloud_dataarts_catalog_metadata_tasks` [GH-9401]
  + `huaweicloud_dataarts_dataservice_api_authorized_apps` [GH-9422]
  + `huaweicloud_dataarts_dataservice_app_authorized_apis` [GH-9402]
  + `huaweicloud_dataarts_dataservice_approvers` [GH-9422]
  + `huaweicloud_dataarts_dataservice_catalog_apis` [GH-9422]
  + `huaweicloud_dataarts_factory_resources` [GH-9288]
  + `huaweicloud_dataarts_factory_scripts` [GH-9302]
  + `huaweicloud_dataarts_quality_consistency_tasks` [GH-9424]
  + `huaweicloud_dataarts_quality_rule_templates` [GH-9424]
  + `huaweicloud_dataarts_security_data_recognition_rules` [GH-9420]
  + `huaweicloud_dataarts_security_dynamic_masking_policies` [GH-9420]
  + `huaweicloud_dataarts_security_permission_set_members` [GH-9420]
  + `huaweicloud_dataarts_security_permission_set_privileges` [GH-9420]
  + `huaweicloud_dataarts_security_permission_sets` [GH-9420]
  + `huaweicloud_dataarts_security_resource_permission_policies` [GH-9420]
  + `huaweicloud_dataarts_security_workspace_associated_queues` [GH-9420]
  + `huaweicloud_dataarts_studio_workspace_user_roles` [GH-9343]
  + `huaweicloud_dataarts_studio_workspace_users` [GH-9380]
  + `huaweicloud_dcs_background_tasks` [GH-9405]
  + `huaweicloud_dcs_backup_file_links` [GH-9421]
  + `huaweicloud_dcs_batch_instance_nodes` [GH-9346]
  + `huaweicloud_dcs_center_tasks` [GH-9331]
  + `huaweicloud_dcs_instance_parameter_modify_records` [GH-9342]
  + `huaweicloud_dcs_offline_key_analyses` [GH-9266]
  + `huaweicloud_dcs_redis_run_logs` [GH-9337]
  + `huaweicloud_dli_queues` [GH-9282]
  + `huaweicloud_dli_spark_jobs` [GH-9257]
  + `huaweicloud_dli_sql_defend_rules` [GH-9255]
  + `huaweicloud_dms_rabbitmq_recycle_instances` [GH-9350]
  + `huaweicloud_elb_all_l7rules` [GH-9271]
  + `huaweicloud_elb_loadbalancer_topology` [GH-9269]
  + `huaweicloud_geminidb_accounts` [GH-9456]
  + `huaweicloud_geminidb_flavors` [GH-9456]
  + `huaweicloud_global_internet_bandwidths_by_tags` [GH-9355]
  + `huaweicloud_organizations_dry_run_policies` [GH-9358]
  + `huaweicloud_organizations_dry_run_policy_attached_entities` [GH-9359]
  + `huaweicloud_rds_auto_ces_alarm` [GH-9438]
  + `huaweicloud_rds_publication_monitor` [GH-9442]
  + `huaweicloud_rds_publication_subscription_profiles` [GH-9448]
  + `huaweicloud_rds_subscription_monitor` [GH-9442]
  + `huaweicloud_rds_subscriptions` [GH-9441]
  + `huaweicloud_rfs_execution_plan_items` [GH-9426]
  + `huaweicloud_rfs_execution_plan_prices` [GH-9417]
  + `huaweicloud_rfs_execution_plans` [GH-9403]
  + `huaweicloud_rfs_private_hook_versions` [GH-9356]
  + `huaweicloud_rfs_private_hooks` [GH-9396]
  + `huaweicloud_rfs_private_module_versions` [GH-9356]
  + `huaweicloud_rfs_private_modules` [GH-9356]
  + `huaweicloud_rfs_private_provider_versions` [GH-9381]
  + `huaweicloud_rfs_private_providers` [GH-9356]
  + `huaweicloud_rfs_stack_instances` [GH-9356]
  + `huaweicloud_rfs_stack_outputs` [GH-9400]
  + `huaweicloud_rfs_stack_resources` [GH-9360]
  + `huaweicloud_rfs_stack_set_operation_metadata` [GH-9356]
  + `huaweicloud_rfs_stack_set_operations` [GH-9409]
  + `huaweicloud_rfs_stacks` [GH-9387]
  + `huaweicloud_rfs_template_versions` [GH-9385]
  + `huaweicloud_rfs_templates` [GH-9356]
  + `huaweicloud_smn_topics_associate_resources` [GH-9284]
  + `huaweicloud_swr_signed_image_associated_image_tags` [GH-9298]
  + `huaweicloud_swr_signed_image_attachments` [GH-9298]
  + `huaweicloud_vpc_address_group_associated_resources` [GH-9306]
  + `huaweicloud_vpc_eip_public_ip_pool_types` [GH-9437]
...
* **New Resource Source:**
  ...
  + `huaweicloud_css_agency_permission` [GH-9186]
  + `huaweicloud_dli_flinksql_job_savepoint_import` [GH-9245]
  + `huaweicloud_dli_flinksql_job_savepoint` [GH-9240]
  + `huaweicloud_dws_cluster_eip_associate` [GH-9260]
  + `huaweicloud_dws_cluster_elb_associate` [GH-9267]
  + `huaweicloud_dws_cluster_exception_rule` [GH-9259]
  + `huaweicloud_dws_cluster_public_domain_associate` [GH-9234]
  + `huaweicloud_gaussdb_backup_stop` [GH-9228]
  + `huaweicloud_gaussdb_backup` [GH-9225]
  + `huaweicloud_gaussdb_database` [GH-9225]
  + `huaweicloud_gaussdb_eip_associate` [GH-9228]
  + `huaweicloud_gaussdb_instance_node_startup` [GH-9228]
  + `huaweicloud_gaussdb_instance_node_stop` [GH-9228]
  + `huaweicloud_gaussdb_instance_restart` [GH-9228]
  + `huaweicloud_gaussdb_instance_upgrade` [GH-9228]
  + `huaweicloud_gaussdb_instance` [GH-9225]
  + `huaweicloud_gaussdb_parameter_template_apply` [GH-9228]
  + `huaweicloud_gaussdb_parameter_template_compare` [GH-9228]
  + `huaweicloud_gaussdb_parameter_template_reset` [GH-9228]
  + `huaweicloud_gaussdb_parameter_template` [GH-9225]
  + `huaweicloud_gaussdb_primary_standby_switch` [GH-9228]
  + `huaweicloud_gaussdb_quota` [GH-9225]
  + `huaweicloud_gaussdb_recycling_policy` [GH-9228]
  + `huaweicloud_gaussdb_restore` [GH-9225]
  + `huaweicloud_gaussdb_schema` [GH-9225]
  + `huaweicloud_gaussdb_sql_throttling_task` [GH-9225]
  + `huaweicloud_gaussdb_sync_sql_throttling_task` [GH-9228]
  + `huaweicloud_gaussdb_task_delete` [GH-9228]
  + `huaweicloud_organizations_dry_run_policy` [GH-9247]
  + `huaweicloud_secmaster_update_workflow_instance` [GH-9238]
  + `huaweicloud_taurusdb_account_privilege` [GH-9230]
  + `huaweicloud_taurusdb_account` [GH-9230]
  + `huaweicloud_taurusdb_backup` [GH-9230]
  + `huaweicloud_taurusdb_database` [GH-9230]
  + `huaweicloud_taurusdb_eip_associate` [GH-9230]
  + `huaweicloud_taurusdb_instance_node_config` [GH-9230]
  + `huaweicloud_taurusdb_instance_restart` [GH-9230]
  + `huaweicloud_taurusdb_instance_upgrade` [GH-9230]
  + `huaweicloud_taurusdb_instance` [GH-9230]
  + `huaweicloud_taurusdb_instant_task_delete` [GH-9230]
  + `huaweicloud_taurusdb_lts_log` [GH-9230]
  + `huaweicloud_taurusdb_parameter_template_apply` [GH-9230]
  + `huaweicloud_taurusdb_parameter_template_compare` [GH-9230]
  + `huaweicloud_taurusdb_parameter_template` [GH-9230]
  + `huaweicloud_taurusdb_proxy_restart` [GH-9230]
  + `huaweicloud_taurusdb_proxy` [GH-9230]
  + `huaweicloud_taurusdb_quota` [GH-9230]
  + `huaweicloud_taurusdb_recycling_policy` [GH-9230]
  + `huaweicloud_taurusdb_restore` [GH-9230]
  + `huaweicloud_taurusdb_scheduled_task_cancel` [GH-9230]
  + `huaweicloud_taurusdb_scheduled_task_delete` [GH-9230]
  + `huaweicloud_taurusdb_sql_control_rule` [GH-9230]
  + `huaweicloud_taurusdb_table_restore` [GH-9230]
  + `huaweicloud_waf_policy_v2` [GH-9264]

* **New Data Source:**
  + `huaweicloud_cce_autopilot_chart_values` [GH-9258]
  + `huaweicloud_cce_autopilot_release_history` [GH-9252]
  + `huaweicloud_cce_release_history` [GH-9254]
  + `huaweicloud_cfw_access_log_statistic_detail` [GH-9218]
  + `huaweicloud_cfw_access_log_statistic` [GH-9216]
  + `huaweicloud_cfw_attack_log_statistic` [GH-9256]
  + `huaweicloud_cfw_domain_resolve_ip_list` [GH-9262]
  + `huaweicloud_cfw_firewall_config_quota` [GH-9248]
  + `huaweicloud_cfw_vpcs_protection` [GH-9270]
  + `huaweicloud_dli_system_sql_defend_rules` [GH-9249]
  + `huaweicloud_dws_cluster_exception_rules` [GH-9259]
  + `huaweicloud_elb_listener_tags` [GH-9201]
  + `huaweicloud_elb_listeners_by_tags` [GH-9204]
  + `huaweicloud_elb_loadbalancer_tags` [GH-9198]
  + `huaweicloud_ga_byoip_pools` [GH-9246]
  + `huaweicloud_ga_pops` [GH-9229]
  + `huaweicloud_ga_quotas` [GH-9223]
  + `huaweicloud_ga_resources_by_tags` [GH-9237]
  + `huaweicloud_gaussdb_available_flavors` [GH-9225]
  + `huaweicloud_gaussdb_backup_files` [GH-9225]
  + `huaweicloud_gaussdb_backups` [GH-9225]
  + `huaweicloud_gaussdb_databases` [GH-9225]
  + `huaweicloud_gaussdb_datastores` [GH-9225]
  + `huaweicloud_gaussdb_error_logs` [GH-9225]
  + `huaweicloud_gaussdb_flavors` [GH-9225]
  + `huaweicloud_gaussdb_instance_coordinators` [GH-9225]
  + `huaweicloud_gaussdb_instance_features` [GH-9225]
  + `huaweicloud_gaussdb_instance_nodes` [GH-9225]
  + `huaweicloud_gaussdb_instance_snapshot` [GH-9225]
  + `huaweicloud_gaussdb_instance` [GH-9225]
  + `huaweicloud_gaussdb_instances` [GH-9225]
  + `huaweicloud_gaussdb_parameter_templates` [GH-9225]
  + `huaweicloud_gaussdb_plugins` [GH-9225]
  + `huaweicloud_gaussdb_predefined_tags` [GH-9225]
  + `huaweicloud_gaussdb_project_quotas` [GH-9225]
  + `huaweicloud_gaussdb_pt_applicable_instances` [GH-9225]
  + `huaweicloud_gaussdb_pt_apply_records` [GH-9225]
  + `huaweicloud_gaussdb_pt_modify_records` [GH-9225]
  + `huaweicloud_gaussdb_quotas` [GH-9225]
  + `huaweicloud_gaussdb_recycling_instances` [GH-9225]
  + `huaweicloud_gaussdb_restorable_instances` [GH-9225]
  + `huaweicloud_gaussdb_restore_time_ranges` [GH-9225]
  + `huaweicloud_gaussdb_schemas` [GH-9225]
  + `huaweicloud_gaussdb_slow_logs` [GH-9225]
  + `huaweicloud_gaussdb_solution_template_setting` [GH-9225]
  + `huaweicloud_gaussdb_sql_templates` [GH-9225]
  + `huaweicloud_gaussdb_sql_throttling_tasks` [GH-9225]
  + `huaweicloud_gaussdb_ssl_cert_download_link` [GH-9225]
  + `huaweicloud_gaussdb_storage_types` [GH-9225]
  + `huaweicloud_gaussdb_tags` [GH-9225]
  + `huaweicloud_gaussdb_tasks` [GH-9225]
  + `huaweicloud_gaussdb_top_io_traffics` [GH-9225]
  + `huaweicloud_gaussdb_upgrade_versions` [GH-9225]
  + `huaweicloud_mapreduce_cluster_files` [GH-9203]
  + `huaweicloud_mapreduce_cluster_synchronized_iam_objects` [GH-9203]
  + `huaweicloud_mapreduce_tags_quota` [GH-9203]
  + `huaweicloud_secmaster_tasks` [GH-9241]
  + `huaweicloud_taurusdb_audit_log_download_links` [GH-9230]
  + `huaweicloud_taurusdb_auto_scaling_records` [GH-9230]
  + `huaweicloud_taurusdb_backups` [GH-9230]
  + `huaweicloud_taurusdb_configuration` [GH-9230]
  + `huaweicloud_taurusdb_configurations` [GH-9230]
  + `huaweicloud_taurusdb_database_character_set` [GH-9230]
  + `huaweicloud_taurusdb_databases` [GH-9230]
  + `huaweicloud_taurusdb_dedicated_resource` [GH-9230]
  + `huaweicloud_taurusdb_diagnosis_instances` [GH-9230]
  + `huaweicloud_taurusdb_diagnosis_statistics` [GH-9230]
  + `huaweicloud_taurusdb_engine_versions` [GH-9230]
  + `huaweicloud_taurusdb_error_logs` [GH-9230]
  + `huaweicloud_taurusdb_flavors` [GH-9230]
  + `huaweicloud_taurusdb_incremental_backups` [GH-9230]
  + `huaweicloud_taurusdb_instance` [GH-9230]
  + `huaweicloud_taurusdb_instances` [GH-9230]
  + `huaweicloud_taurusdb_instant_tasks` [GH-9230]
  + `huaweicloud_taurusdb_project_quotas` [GH-9230]
  + `huaweicloud_taurusdb_proxies` [GH-9230]
  + `huaweicloud_taurusdb_proxy_flavors` [GH-9230]
  + `huaweicloud_taurusdb_pt_applicable_instances` [GH-9230]
  + `huaweicloud_taurusdb_pt_apply_records` [GH-9230]
  + `huaweicloud_taurusdb_pt_modify_records` [GH-9230]
  + `huaweicloud_taurusdb_recycling_instances` [GH-9230]
  + `huaweicloud_taurusdb_restore_time_ranges` [GH-9230]
  + `huaweicloud_taurusdb_restored_tables` [GH-9230]
  + `huaweicloud_taurusdb_scheduled_tasks` [GH-9230]
  + `huaweicloud_taurusdb_slow_logs` [GH-9230]
  + `huaweicloud_waf_instance_tags` [GH-9251]
...
* **New Resource:**
  ...
  + `huaweicloud_cce_autopilot_cluster_upgrade` [GH-8709]
  + `huaweicloud_cce_autopiot_release` [GH-8692]
  + `huaweicloud_cce_release` [GH-8709]
  + `huaweicloud_dms_kafka_instance_public_access_switch` [GH-8715]
  + `huaweicloud_hss_associated_asset_importance` [GH-8695]
  + `huaweicloud_hss_change_host_ignore_status` [GH-8653]
  + `huaweicloud_hss_host_manual_detection` [GH-8713]
  + `huaweicloud_hss_login_white_ip` [GH-8646]
  + `huaweicloud_identityv5_policy_default_version` [GH-8652]
  + `huaweicloud_identityv5_policy_group_attach` [GH-8640]
  + `huaweicloud_identityv5_policy_user_attach` [GH-8637]
  + `huaweicloud_identityv5_service_linked_agency` [GH-8712]
  + `huaweicloud_mapreduce_cluster_component_batch_add` [GH-8663]
  + `huaweicloud_mapreduce_cluster_node_batch_expand` [GH-8613]
  + `huaweicloud_mapreduce_cluster_node_batch_shrink` [GH-8613]
  + `huaweicloud_secmaster_soc_mapping_clone` [GH-8714]
  + `huaweicloud_secmaster_soc_mapping_delete` [GH-8679]
  + `huaweicloud_secmaster_workflow` [GH-8673]
  + `huaweicloud_waf_batch_create_antileakage_rules` [GH-8682]
  + `huaweicloud_waf_batch_create_cc_rules` [GH-8707]
  + `huaweicloud_waf_batch_create_custom_rules` [GH-8698]
  + `huaweicloud_waf_batch_create_ignore_rules` [GH-8696]
  + `huaweicloud_waf_batch_create_ip_reputation_rules` [GH-8710]
  + `huaweicloud_waf_batch_create_whiteblackip_rules` [GH-8681]
  + `huaweicloud_waf_batch_delete_alarm_notifications` [GH-8675]
  + `huaweicloud_waf_dedicated_agency` [GH-8373]
  + `huaweicloud_workspace_desktop_pool_expand` [GH-8678]

* **New Data Source:**
  + `huaweicloud_bms_available_resources` [GH-8648]
  + `huaweicloud_bms_instance_password` [GH-8656]
  + `huaweicloud_bms_quotas` [GH-8689]
  + `huaweicloud_bms_volume_attachments` [GH-8651]
  + `huaweicloud_cce_access_policies` [GH-8709]
  + `huaweicloud_cce_autopilot_addons` [GH-8709]
  + `huaweicloud_cce_autopilot_charts` [GH-8709]
  + `huaweicloud_cce_autopilot_cluster_log_configs` [GH-8709]
  + `huaweicloud_cce_autopilot_cluster_upgrade_info` [GH-8709]
  + `huaweicloud_cce_autopilot_releases` [GH-8709]
  + `huaweicloud_cce_chart_values` [GH-8709]
  + `huaweicloud_cce_cluster_configuration_details` [GH-8709]
  + `huaweicloud_cce_flavor_specifications` [GH-8709]
  + `huaweicloud_cce_image_caches` [GH-8709]
  + `huaweicloud_cce_releases` [GH-8709]
  + `huaweicloud_hss_baseline_check_rule_fail_detail` [GH-8672]
  + `huaweicloud_hss_baseline_risk_config_check_rules` [GH-8659]
  + `huaweicloud_hss_baseline_security_checks_default_policy` [GH-8704]
  + `huaweicloud_hss_baseline_statistic` [GH-8674]
  + `huaweicloud_hss_image_local_hosts` [GH-8690]
  + `huaweicloud_hss_image_pay_per_scan_statistics` [GH-8657]
  + `huaweicloud_hss_image_sensitive_information_detail` [GH-8676]
  + `huaweicloud_hss_image_sensitive_information` [GH-8676]
  + `huaweicloud_hss_vulnerability_host_vulnerabilities` [GH-8703]
  + `huaweicloud_identityv5_access_key` [GH-8712]
  + `huaweicloud_identityv5_agency_attached_policies` [GH-8712]
  + `huaweicloud_identityv5_policy_versions` [GH-8712]
  + `huaweicloud_identityv5_user_attached_policies` [GH-8712]
  + `huaweicloud_secmaster_dataspaces` [GH-8708]
  + `huaweicloud_secmaster_soc_mappers` [GH-8685]
  + `huaweicloud_secmaster_soc_mappings` [GH-8673]
  + `huaweicloud_secmaster_soc_preprocess_rules` [GH-8693]
  + `huaweicloud_waf_web_basic_protection_rules` [GH-8658]
...
* **New Resource:**
  ...
  + `huaweicloud_dns_zone_retrieval` [GH-8523]
  + `huaweicloud_elb_member_check_task` [GH-8515]
  + `huaweicloud_elb_recycle_bin_loadbalancer_delete` [GH-8510]
  + `huaweicloud_elb_recycle_bin_loadbalancer_revocer` [GH-8510]
  + `huaweicloud_elb_recycle_bin` [GH-8503]
  + `huaweicloud_esw_connection_vport_bind` [GH-8486]
  + `huaweicloud_esw_connection` [GH-8467]
  + `huaweicloud_hss_login_common_location` [GH-8521]
  + `huaweicloud_hss_policy_group` [GH-8071]
  + `huaweicloud_hss_policy_switch_status` [GH-8512]
  + `huaweicloud_hss_ransomware_protection_policy` [GH-8480]
  + `huaweicloud_swr_repository_tag` [GH-8462]
  + `huaweicloud_workspace_app_application_batch_publish` [GH-8501]
  + `huaweicloud_workspace_app_application_batch_unpublish` [GH-8501]
  + `huaweicloud_workspace_app_server_batch_migrate` [GH-8446]
  + `huaweicloud_workspace_desktop_maintenance_batch_manage` [GH-8527]
  + `huaweicloud_workspace_notification_rule` [GH-8460]
  + `huaweicloud_workspace_ou` [GH-8525]
  + `huaweicloud_workspace_user_action` [GH-8465]

* **New Data Source:**
  + `huaweicloud_cdn_domain_template_apply_records` [GH-8487]
  + `huaweicloud_deh_instance_servers` [GH-8511]
  + `huaweicloud_deh_instance_tags` [GH-8511]
  + `huaweicloud_deh_instances_by_tags` [GH-8511]
  + `huaweicloud_deh_quotas` [GH-8511]
  + `huaweicloud_elb_loadbalancer_ports` [GH-8522]
  + `huaweicloud_elb_loadbalancer_status` [GH-8530]
  + `huaweicloud_elb_recycle_bin_loadbalancers` [GH-8503]
  + `huaweicloud_esw_all_connections` [GH-8467]
  + `huaweicloud_esw_connections` [GH-8467]
  + `huaweicloud_esw_jobs` [GH-8470]
  + `huaweicloud_hss_agent_auto_upgrade_config` [GH-8500]
  + `huaweicloud_hss_agent_versions` [GH-8474]
  + `huaweicloud_hss_app_agent_statistics` [GH-8478]
  + `huaweicloud_hss_asset_overview_account_top` [GH-8494]
  + `huaweicloud_hss_asset_overview_auto_launch_top` [GH-8505]
  + `huaweicloud_hss_asset_overview_statistics_top_ports` [GH-8504]
  + `huaweicloud_hss_asset_overview_status_quotas` [GH-8472]
  + `huaweicloud_hss_billing_version` [GH-8492]
  + `huaweicloud_hss_container_kubernetes_mciuc` [GH-8507]
  + `huaweicloud_hss_container_kubernetes_template` [GH-8506]
  + `huaweicloud_hss_event_att_ck_statistics` [GH-8534]
  + `huaweicloud_hss_hosts_risk` [GH-8485]
  + `huaweicloud_hss_image_registries` [GH-8498]
  + `huaweicloud_hss_image_registry_images` [GH-8496]
  + `huaweicloud_hss_image_registry_statistics` [GH-8488]
  + `huaweicloud_hss_image_upload_command` [GH-8484]
  + `huaweicloud_hss_image_whitelists` [GH-8490]
  + `huaweicloud_hss_malware_collect_status` [GH-8483]
  + `huaweicloud_hss_operational_report_welfare` [GH-8514]
  + `huaweicloud_hss_overview_agent_statistics` [GH-8536]
  + `huaweicloud_hss_overview_hot_information` [GH-8513]
  + `huaweicloud_hss_overview_protection_statistics` [GH-8529]
  + `huaweicloud_hss_policy_switch_status` [GH-8512]
  + `huaweicloud_hss_security_check_config` [GH-8471]
  + `huaweicloud_hss_setting_alarm_configuration` [GH-8526]
  + `huaweicloud_hss_setting_dictionaries` [GH-8493]
  + `huaweicloud_hss_setting_malware_reminders` [GH-8491]
  + `huaweicloud_hss_setting_plugins` [GH-8520]
  + `huaweicloud_hss_setting_switches_status` [GH-8509]
  + `huaweicloud_hss_setting_virus_kill` [GH-8497]
  + `huaweicloud_hss_vulnerability_host_apps` [GH-8516]
  + `huaweicloud_hss_vulnerability_task_statistics` [GH-8489]
  + `huaweicloud_ims_images_by_tags` [GH-8539]
  + `huaweicloud_lb_whitelists` [GH-8533]
  + `huaweicloud_secmaster_collector_parser_templates` [GH-8538]
  + `huaweicloud_secmaster_pipes` [GH-8535]
  + `huaweicloud_swrv3_image_tags` [GH-8466]
  + `huaweicloud_workspace_app_original_policy` [GH-8477]
  + `huaweicloud_workspace_app_policy_groups` [GH-8473]
  + `huaweicloud_workspace_ous` [GH-8525]
  + `huaweicloud_workspace_tenant_configurations` [GH-8481]
  + `huaweicloud_workspace_user_desktop_pool_associations` [GH-8482]
  + `huaweicloud_workspace_user_groups` [GH-8463]
...
* **New Resource:**
  ...
  + `huaweicloud_identitycenter_application_instance_profile_delete` [GH-8387]
  + `huaweicloud_identitycenter_email_verify` [GH-8387]
  + `huaweicloud_identitycenter_mfa_management_setting` [GH-8387]
  + `huaweicloud_identitycenter_password_policy` [GH-8387]
  + `huaweicloud_identitycenter_password_reset` [GH-8387]
  + `huaweicloud_identitycenter_profile_disassociate` [GH-8387]
  + `huaweicloud_identitycenter_sso_configuration` [GH-8387]
  + `huaweicloud_identitycenter_user_session_delete` [GH-8387]
  + `huaweicloud_identityv5_access_key` [GH-8384]
  + `huaweicloud_identityv5_group_membership` [GH-8384]
  + `huaweicloud_identityv5_group` [GH-8384]
  + `huaweicloud_identityv5_virtual_mfa_device` [GH-8384]
  + `huaweicloud_nat_private_transit_subnet` [GH-8392]
  + `huaweicloud_workspace_application_rule_restriction_setting` [GH-8353]
  + `huaweicloud_workspace_application_visibility_batch_action` [GH-8369]

* **New Data Source:**
  + `huaweicloud_aom_alarm_notified_histories` [GH-8270]
  + `huaweicloud_apig_instance_ingress_associated_domains` [GH-8309]
  + `huaweicloud_cdn_domain_owner_verification` [GH-8330]
  + `huaweicloud_enterprise_project_associated_resources` [GH-8390]
  + `huaweicloud_enterprise_project_configs` [GH-8390]
  + `huaweicloud_enterprise_project_migrate_record` [GH-8390]
  + `huaweicloud_enterprise_project_resources_mapping` [GH-8390]
  + `huaweicloud_hss_asset_midwares` [GH-8329]
  + `huaweicloud_hss_asset_port_detail` [GH-8314]
  + `huaweicloud_hss_auto_launch_change_history` [GH-8323]
  + `huaweicloud_hss_container_kubernetes_mcc` [GH-8375]
  + `huaweicloud_hss_container_network_security_groups` [GH-8365]
  + `huaweicloud_hss_event_intrusion_events` [GH-8367]
  + `huaweicloud_hss_image_baseline_risk_configs` [GH-8332]
  + `huaweicloud_hss_image_local_repositories` [GH-8337]
  + `huaweicloud_hss_image_vulnerability_cves` [GH-8338]
  + `huaweicloud_hss_kubernetes_pods` [GH-8354]
  + `huaweicloud_hss_kubernetes_service_detail` [GH-8343]
  + `huaweicloud_hss_ransomware_backup_operation_logs` [GH-8388]
  + `huaweicloud_hss_vulnerability_scan_task_hosts` [GH-8348]
  + `huaweicloud_hss_vulnerability_scan_tasks` [GH-8336]
  + `huaweicloud_hss_webtamper_rasp_protect_history` [GH-8377]
  + `huaweicloud_identitycenter_application_assignments` [GH-8387]
  + `huaweicloud_identitycenter_application_instance_profiles` [GH-8387]
  + `huaweicloud_identitycenter_application_instances` [GH-8387]
  + `huaweicloud_identitycenter_application_providers` [GH-8387]
  + `huaweicloud_identitycenter_applications` [GH-8387]
  + `huaweicloud_identitycenter_group_memberships` [GH-8387]
  + `huaweicloud_identitycenter_identity_store_associations` [GH-8387]
  + `huaweicloud_identitycenter_mfa_devices` [GH-8387]
  + `huaweicloud_identitycenter_user_sessions` [GH-8387]
  + `huaweicloud_identityv5_account_feature_status` [GH-8384]
  + `huaweicloud_identityv5_account_summary` [GH-8384]
  + `huaweicloud_identityv5_authorization_schema` [GH-8384]
  + `huaweicloud_identityv5_group_attached_policies` [GH-8384]
  + `huaweicloud_identityv5_groups` [GH-8384]
  + `huaweicloud_identityv5_policies` [GH-8384]
  + `huaweicloud_identityv5_registered_services` [GH-8384]
  + `huaweicloud_identityv5_service_principals` [GH-8384]
  + `huaweicloud_identityv5_users` [GH-8384]
  + `huaweicloud_identityv5_virtual_mfa_devices` [GH-8384]
  + `huaweicloud_nat_private_transit_subnets` [GH-8392]
  + `huaweicloud_ram_permission_versions` [GH-8393]
  + `huaweicloud_ram_quotas` [GH-8393]
  + `huaweicloud_ram_resource_types` [GH-8393]
  + `huaweicloud_ram_tags` [GH-8393]
  + `huaweicloud_rgc_account_compliance_status` [GH-8382]
  + `huaweicloud_rgc_account_controls` [GH-8382]
  + `huaweicloud_rgc_account_enabled_control` [GH-8382]
  + `huaweicloud_rgc_accounts` [GH-8382]
  + `huaweicloud_rgc_best_practice_account_info` [GH-8382]
  + `huaweicloud_rgc_best_practice_details` [GH-8382]
  + `huaweicloud_rgc_best_practice_overview` [GH-8382]
  + `huaweicloud_rgc_config_rule_compliances` [GH-8382]
  + `huaweicloud_rgc_control_detail` [GH-8382]
  + `huaweicloud_rgc_control_violations` [GH-8382]
  + `huaweicloud_rgc_controls` [GH-8382]
  + `huaweicloud_rgc_core_account` [GH-8382]
  + `huaweicloud_rgc_drift_details` [GH-8382]
  + `huaweicloud_rgc_enabled_controls` [GH-8382]
  + `huaweicloud_rgc_external_config_rule_compliances` [GH-8382]
  + `huaweicloud_rgc_organizational_unit_compliance_status` [GH-8382]
  + `huaweicloud_rgc_organizational_unit_controls` [GH-8382]
  + `huaweicloud_rgc_organizational_unit_enabled_control` [GH-8382]
  + `huaweicloud_rgc_predefined_templates` [GH-8382]
  + `huaweicloud_rgc_template_deploy_params` [GH-8382]
  + `huaweicloud_swr_enterprise_instance_all_artifacts` [GH-8360]
  + `huaweicloud_swr_enterprise_instance_artifact_accessories` [GH-8357]
  + `huaweicloud_swr_enterprise_instance_artifacts` [GH-8342]
  + `huaweicloud_swr_enterprise_replication_policy_execution_record_sub_tasks` [GH-8335]
  + `huaweicloud_swr_enterprise_replication_policy_execution_record_tasks` [GH-8331]
  + `huaweicloud_swr_enterprise_replication_policy_execution_records` [GH-8324]
  + `huaweicloud_swr_enterprise_repository_tags` [GH-8362]
  + `huaweicloud_swr_enterprise_retention_policy_execution_record_tasks` [GH-8394]
  + `huaweicloud_waf_dedicated_agency` [GH-8373]
  + `huaweicloud_waf_policy_ip_reputation` [GH-8376]
  + `huaweicloud_waf_protectable_resources` [GH-8383]
  + `huaweicloud_waf_rules_protection_types` [GH-8368]
  + `huaweicloud_waf_security_report_history_periods` [GH-8364]
  + `huaweicloud_waf_security_report_sending_records` [GH-8386]
  + `huaweicloud_waf_security_report_subscription` [GH-8381]
  + `huaweicloud_workspace_application_restricted_rules` [GH-8358]
  + `huaweicloud_workspace_quotas` [GH-8358]
  + `huaweicloud_workspace_scheduled_task_records` [GH-8358]
  + `huaweicloud_workspace_scheduled_tasks` [GH-8358]
  + `huaweicloud_workspace_timezones` [GH-8358]
